...
struct PromptGenerator {
    ...
    static func generatePrompt(for input: String) -> String {
        ...
        - "location": The specific sentence(s) or phrase(s) in the input text where the fallacy occurs.
        ...
        Respond ONLY with the JSON array as described above. Do not change any characters, spacing, or other aspects of the input string when forming the "location" strings - return them exactly as they were input.
